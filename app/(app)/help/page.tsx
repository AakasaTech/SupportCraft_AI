...
export const metadata: Metadata = { title: "Help & Support — SupportCraft AI" };
...
export default function HelpPage() {
  return (
    <div>
      <Header
        title="Help & Support"
        description="Find answers, book a call, or raise a support ticket with our team."
      />
      ...
      <div className="max-w-2xl space-y-6 p-4 sm:p-6">
        ...
        <HelpCard
          ...
          desc="Step-by-step guides covering every feature in SupportCraft AI."
        >
          <Link
            href="/docs"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-hover"
          >
